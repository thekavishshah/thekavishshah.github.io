    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              {data?.preferences.location || "Based in Arizona, USA, open to remote and on-site opportunities 🇺🇸"}
            </p>
          </div>
        </div>
      ...
      <div className="mt-10">
        ...
        <p className="text-foreground text-sm">
          {data?.experience.internshipCompleted || "Real-world AI and ML experience."} <br /> 
          {data?.achievements[0] || "A strong passion and enthusiasm in collaboarating and programming"} <br /> 
          {data?.experience.freelanceWork || "A decent experience and skill in Software Development"}
        </p>
      </div>
